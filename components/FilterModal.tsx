...
export function FilterModal({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-end bg-black/20 backdrop-blur-sm transition-opacity duration-300 ${
        isOpen ? "opacity-100" : "opacity-0 pointer-events-none"
      }`}
      onClick={onClose}>
      <div
        className={`h-[95vh] w-full max-w-md bg-white m-2 rounded-2xl shadow-2xl flex flex-col transition-transform duration-300 ease-out transform ${
